...
document.oncut = function(){ Swal.fire({ position: "top-end", icon: "warning", title: "本站禁止剪切！", timer: 2000, timerProgressBar: true, showConfirmButton: false }); return false; }; // 禁止剪切 
document.oncopy = function(){ Swal.fire({ position: "top-end", icon: "warning", title: "本站禁止复制！", timer: 2000, timerProgressBar: true, showConfirmButton: false }); return false; }; // 禁止复制
document.oncontextmenu = function(){ Swal.fire({ position: "top-end", icon: "warning", title: "本站禁止右键菜单！", timer: 2000, timerProgressBar: true, showConfirmButton: false }); return false; }; // 禁止右键菜单
